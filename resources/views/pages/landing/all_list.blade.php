...
<head>
<meta charset="UTF-8">
<title>Medfin | {{$tittle}}</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
<link rel="shortcut icon" href="https://m2.medfin.in/medfin/favicon.png" type="image/x-icon">
<link rel="stylesheet" href="https://assets.medfin.in/v02.12.23/assets-v3/common/css/bootstrap.min.css" as="style" onload="this.rel='stylesheet'">
<link rel="preload" href="https://m2.medfin.in/medfin/css/lp-15.css" as="style" onload="this.rel='stylesheet'">
<!-- <link rel="preload" href="https://medfincms.s3.ap-south-1.amazonaws.com/lp-15.css" as="style" onload="this.rel='stylesheet'"> -->
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Swiper/11.0.5/swiper-bundle.css" onload="this.media='all'">
...
<script> document.write('<s'+'cript language="JavaScript" src="https://m2.medfin.in/medfin/js/validate.js"></s'+'cript>')</script>
<script> document.write('<s'+'cript language="JavaScript" src="https://m.medfin.in/assets/js/additional-methods.min.js" async></s'+'cript>')</script>
<script> document.write('<s'+'cript language="JavaScript" src="https://m2.medfin.in/medfin/js/blockUI.js" defer></s'+'cript>')</script>
<!--contact number--->
<?php
...
<script>
    (function(h,o,t,j,a,r){
        ...
        h._hjSettings={hjid:475168,hjsv:5};
...
<script src="https://www.googletagmanager.com/gtag/js?id=UA-89417594-1" async></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments)};
  gtag('js', new Date());

  gtag('config', 'UA-89417594-1');
</script>
<script>
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  ...
  ga('create', 'UA-89417594-1', 'auto');
  ga('require', 'GTM-NS5WBF9');
</script>
<script>
...
'https://connect.facebook.net/en_US/fbevents.js');
 fbq('init', '436206780236595'); 
fbq('track', 'PageView');
fbq('track', 'LPPageView');
</script>
<noscript>
 <img height="1" width="1" src="https://www.facebook.com/tr?id=436206780236595&ev=PageView&noscript=1"/>
</noscript>
<noscript>
 <img height="1" width="1" src="https://www.facebook.com/tr?id=436206780236595&ev=LPPageView&noscript=1"/>
</noscript>
...
})(window,document,'script','dataLayer','GTM-WDFC4NQ');</script>

<script src="https://cdn.trackjs.com/agent/v3/latest/t.js" async></script>
<script>
  window.TrackJS && TrackJS.install({ 
    token: "6203d78ff6c04f7eb0359dbe7a827da5",
...
<script src="https://use.fontawesome.com/47886b77a3.js" defer></script>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
 <div class="container">
	 <a class="navbar-brand" href="{{URL::to('/')}}"><img class="white-logo" src="{{ asset('medfin/images/medfin-logo-white.svg') }}" height="27" width="120" alt=""><img class="blue-logo" src="{{ asset('medfin/images/medfin-logo.svg') }}" height="27" width="120" alt=""></a>
	...
	<a class="btn btn-appointment" href="javascript:void(0)"  data-toggle="modal" data-target="#appointment-form"><span class="btn-appointment-icon"></span> Book Appointment</a>
			...
			<ul class="navbar-nav">
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle btn text-light @if($service->page_status == 0) bg-warning @else bg-success @endif" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
							aria-haspopup="true" aria-expanded="false">
							@if($service->page_status == 0)<span class="text-light"> Draft Mode</span> @else <span class="text-light"> Publish Mode </span> @endif
							</a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                  ...
                  <img class="avatar" src="{{asset('app-assets/img/portrait/small/user.jpg')}}" alt="avatar" 
                    height="35" width="35"></img>
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item"><b>{{Session::get('first_name')}} {{Session::get('last_name')}}</b></a>
                  @if(Session::get('user_role') == 'Admin')
...
{{-- Status Activate Modal --}}
									...
									<div class="modal-body text-center">
											<div class="alert flex-center">
												...
												<form action="{{ route('/page_archive') }}" method="POST">
														...
														<input type="text" name="service_id" value="{{$service->id ?? ''}}"
															hidden>
														<input type="text" name="deactivate" value="Archive" hidden>
														<button type="submit" class="btn btn-danger ml-2">Yes</button>
												</form>
											</div>
									</div>
							...
							<section id="about" class="container-fluid home-banner">
								<div class="container align-items-center">
									<div class="row align-items-center">
										<div class="col-md-6">
											<div>
											<img class="banner-img" src="https://medfincms.s3.ap-south-1.amazonaws.com/{{ $banner->image ?? ''}}" alt="Banner Image"   width="100%" height="100"></img>
											</div>
										</div>
							...
							<div class="container align-items-center" id="myDIV">
								<div class="row align-items-center">
									<div class="col-md-5">
										...
										<img class="lazy banner-img" id="blah" data-original="{{asset('medfin/images/banner-img.jpg')}}"  style="width: 90%;" ></img>
						...
						@endif
						<!-- Top Form Starts -->
						<section class="container-fluid top-form  d-block">
							<div class="container">
							<div class="row justify-content-center">
								<div class="col-md-12">
									<form class="form-holder" name="myform" id="myform">
												<div class="row align-items-center">
												<h4 class="book-cosultaion-mobile">@if (empty($btn->title)) Cost Estimate Calculator @else {{$btn->title ?? ''}} @endif</h4>
													<div class="form-group col-lg-4">
														<!-- <div style="position: absolute; top: 13px; left: 20px;"><img class="lazy left form-icon-img" data-original="{{ asset('medfin/images/user.svg') }}" alt="" width="20"></div> -->
														<input type="text" class="form-control border-0" name="name" id="name" placeholder="Name">
													</div>
													<input type="text" id="serviceID" value="{{$service->service_id ?? ''}}" hidden>
													<div class="form-group col-lg-4">
														<!-- <div style="position: absolute; top: 13px; left: 20px;"><img class="lazy left form-icon-img" data-original="{{ asset('medfin/images/mobile.svg') }}" alt="" width="20"></div> -->
														<input style="display: block;" class="form-control border-0" id="mobile" name="mobile" type="tel" placeholder="Mobile Number">
													</div>
													<div class="form-group col-lg-4 text-right big-scn">
														<button type="button" class="btn btn-danger btn-lg text-center" onclick="MEDFINAPP.createLeadRequestWithSource('myform','NORMAL-FLOW','','Book Appointment');">@if (empty($btn->btn_name)) Book a Free Consultation @else {{$btn->btn_name ?? ''}} @endif</button>
													</div>
													<!-- <div class="form-group col-lg-4 text-center sml-scn">
														<button type="button" class="btn btn-danger btn-lg text-center" onclick="MEDFINAPP.createLeadRequestWithSource('myform','NORMAL-FLOW','','Book Appointment');">Submit</button>
													</div> -->
												</div>
									</form>
								</div>
						...
						<div class="container">	
							<div class="row">
										<div class="col-md-6 hero d-none d-md-block">
											<img  class="lazy img-fluid" data-original="https://medfincms.s3.ap-south-1.amazonaws.com/{{ $overview->image ?? ''}}" alt="Overview Image" width="100%" height="100">
										</div>
										<div class="col-md-6">
											<h2>{{$overview->tittle ?? '' }}?</h2>
											<span class="hero d-md-none"><img class="lazy img-fluid" data-original="https://medfincms.s3.ap-south-1.amazonaws.com/{{ $overview->image ?? ''}}"   width="100%" height="100"></span>
						...
						<section class="container-fluid why-this-surgery">
							...
							<div class="row">
								<div class="col-md-5 hero d-none d-md-block">
										...
										<input type="text" name="service_id" value="{{$service->id ?? ''}}" hidden>
											<img id="over" class="lazy img-fluid" data-original="{{ asset('medfin/images/why_surgery.jpg') }}" height="120"  />
											<input type="file" id="overview" name="image">
								</div>
								<div class="col-md-5">
										<input class="form-control mb-2" name="overview_tittle" value="{{$overview->tittle ?? '' }}">
											<textarea name="overview_description" id="overview_description" style="background-color: white;">{{$overview->description ?? '' }}</textarea>
											<div class="text-center mt-3">
											<button type="submit" class="btn btn-success" >Update</button>
											</div>  
								</div>  
						...
						<section class="container-fluid diagnosis ash-bg">
							...
							<div class="row">
										...
										<div class="form-group">
											...
											<input type="text"  name="treatment_heading" class="form-control" placeholder="Treatment Options ...." value="{{$treatment->heading ?? ''}}"
												Required>
										</div>
										</div>
										<div class="col-md-5">
						...
						<section class="container-fluid meaning-of-surgery">
							...
							<div class="row">
										...
										<div class="col-md-6">
											...
											@if (!empty($symptoms->acc_head_1 ?? ''))
													<div class="card">
														...
														<h5 class="mb-0">
															<button class="btn title collapsed" data-toggle="collapse" data-target="#collapseOne34" aria-expanded="false" aria-controls="collapseOne34">
														...
														<div id="collapseOne34" class="collapse" aria-labelledby="collapseOne34" data-parent="#accordion2">
														<div class="card-body">
															<div class="row align-items-center">
																<div class="col-12">
													...
													<div class="card">
														<div class="card-header" id="headingFour">
														<h5 class="mb-0">
															<button class="btn title collapsed" data-toggle="collapse" data-target="#collapseTwo22" aria-expanded="false" aria-controls="collapseTwo22">
														...
														<div id="collapseTwo22" class="collapse" aria-labelledby="collapseTwo22" data-parent="#accordion2">
														<div class="card-body">
															<div class="row align-items-center">
																<div class="col-12">
										...
										<div class="col-md-6 hero d-none d-md-block">
											<img class="lazy img-fluid" data-original="https://medfincms.s3.ap-south-1.amazonaws.com/{{ $symptoms->image ?? ''}}" >
										</div>
						      	</div>
							</div>	
						</section>
						...
						<section class="container-fluid meaning-of-surgery">
							...
							<div class="row">
										...
										<div class="form-group">
											<label for="title">Heading</label>
											<input type="text"  name="symptoms_heading" class="form-control" placeholder="Meaning / Causes & Symptoms" value="{{$symptoms->heading ?? ''}}"
												Required>
										</div>
										</div>
										<div class="col-md-5">
										...
										<div class="col-md-7 rhs">
										<div class="form-group">
											<img id="sym" class="lazy" data-original="{{asset('images/why_surgery.jpg')}}" height="170" />
							...
							<div class="container">
								...
								<div class="row">
									...
									<div class="swiper-wrapper">
										@foreach(array_slice($doctor['data'], 0, 5) as $i => $v)
													...
													<div class="card">
														<div class="card-header">
															<div class="doc-photo">
																...
																<img  src="https://medfin-assets.s3.amazonaws.com/converted/doctor-images/{{$v['profileURLImage']}}" onerror="this.src='{{ asset('images/doctor.png') }}'" alt="doctor image"  width="120" height="120">
																<!-- <img class="lazy" data-original="{{ asset('images/doctor.png') }}" alt="doctor image"  width="120px" height="120px"> -->
																@else
							...
							<div class="row">
								<div class="col-md-4 why-medfin-card">
									<div class="why-medfin-card-inner">
											<div class="media align-items-center">
												<img class="lazy mr-3" data-original="{{ asset('medfin/images/patient-care.svg') }}" height="70" width="70">
												<div class="media-body">
								...
								<div class="col-md-4 why-medfin-card">
									<div class="why-medfin-card-inner">
											<div class="media align-items-center">
												<img class="lazy mr-3" data-original="{{ asset('medfin/images/affordable-pricing.svg') }}" height="70" width="70">
												<div class="media-body">
								...
								<div class="col-md-4 why-medfin-card">
									<div class="why-medfin-card-inner">
											<div class="media align-items-center">
												<img class="lazy mr-3" data-original="{{ asset('medfin/images/medical-financing.svg') }}" height="70" width="70">
												<div class="media-body">
								...
								<div class="col-md-4 why-medfin-card">
									<div class="why-medfin-card-inner">
											<div class="media align-items-center">
												<img class="lazy mr-3" data-original="{{ asset('medfin/images/hassle-free.svg') }}" height="70" width="70">
												<div class="media-body">
								...
								<div class="col-md-4 why-medfin-card">
									<div class="why-medfin-card-inner">
											<div class="media align-items-center">
												<img class="lazy mr-3" data-original="{{ asset('medfin/images/expert-surgeons.svg') }}" height="70" width="70">
												<div class="media-body">
								...
								<div class="col-md-4 why-medfin-card">
									<div class="why-medfin-card-inner">
											<div class="media align-items-center">
												<img class="lazy mr-3" data-original="{{ asset('medfin/images/latest-technology.svg') }}" height="70" width="70">
												<div class="media-body">
						...
						<section class="container-fluid advantages">
							...
							<div class="row align-items-center">
								...
								<div class="col-md-7">
									<img class="lazy img-fluid" data-original="https://medfincms.s3.ap-south-1.amazonaws.com/{{ $advantage->image ?? ''}}">
								</div>
							</div>
						...
						<section class="container-fluid advantages">
							...
							<div class="row align-items-center">
								<div class="col-md-7">
								<label for="title">Heading</label>
								<input type="text"  name="heading" class="form-control" placeholder="Advantages of surgery.." value="{{ $advantage->heading  ?? '' }}"
									Required>
								</div>
								<div class="col-md-5">
								<img class="lazy img-fluid"  id="adv" data-original="{{ asset('images/adv.jpg') }}" />
												...
												<div class="col-12 p-0">
													<div class="card">
														<div class="card-header text-left">
															<img class="lazy" data-original="{{ asset('medfin/images/quote.svg') }}" height="22px" width="40" >
														</div>
						...
						<section class="container-fluid faq-sec">
							...
							<div class="row">
										...
										<div class="col-md-6 hero d-none d-md-block">
											<img class="lazy img-fluid" data-original="{{ asset('medfin/images/faq.jpg') }}" >
										</div>
										<div class="col-md-6">
						...
						<!-- FAQ Section Ends -->
						@if(Session::get('user_role') == 'Admin')
						<h4 class="text-center mt-3 text-primary">FAQ Section</h4>
						<!--Faq Section edit--->
						...
						<div class="container-fluid multi-sticky d-md-none">
							<div class="row">
								<a class="col btn btn-lg btn-danger"  href="javascript:void(0)" data-toggle="modal" data-target="#appointment-form">@if (empty($btn->btn_name)) Book a Free Consultation @else {{$btn->btn_name ?? ''}} @endif</a>
								<a class="col btn btn-lg btn-info" href="tel:{{$contact ?? '7026200200'}}">Call Now</a>
							</div>
						</div>
						<!-- Multi Sticky Buttons Ends -->	
						<a class="btn btn-appointment btn-appointment-sticky-desktop" href="javascript:void(0)" data-toggle="modal" data-target="#appointment-form"><span class="left-arrow-icon"></span>@if (empty($btn->btn_name)) Book a Free Consultation @else {{$btn->btn_name ?? ''}} @endif</a>		
						<a href="whatsapp://send?phone=917406557599&text={{$whatsapp ?? 'Tell me more about Medfin'}}" class="whtsap"><img  width="40" src="{{ asset('medfin/images/whatsapp.svg') }}"></a>	
						<!-- Sidebar Form Starts -->
							...
							<div class="modal-body">
								<form id="book-appointment" name="book-appointment">
									<div class="container-fluid appointment-form">
										...
										<a class="col btn btn-lg btn-appointment"  onclick="MEDFINAPP.createLeadRequestWithSource('book-appointment','NORMAL-FLOW','','Book Appointment');" href="javascript:void(0)" >@if (empty($btn->btn_name)) Book a Free Consultation @else {{$btn->btn_name ?? ''}} @endif</a>
									</div>
								</form>
								@if(Session::get('user_role') == 'Admin')
									<form action="{{route('master.btn')}}"
										...
										<input type="text" name="service_id" value="{{$service->id ?? ''}}" hidden>
										<input class="form-control my-4"  name="btn_name" value="{{$btn->btn_name ?? ''}}" placeholder="Book a Consultation">
										<label class="ml-2">Mobile Banner Form Title</label>
										<input class="form-control"  name="title" value="{{$btn->title ?? ''}}" placeholder="Cost Estimate Calculator">
										</div>
...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Quicksand:300,400,500,700|Roboto+Condensed:300,400,700|Roboto:400,500,700,900" media="print" onload="this.media='all'">	
...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Mulish:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" media="print" onload="this.media='all'">
...
<script defer src="https://m2.medfin.in/medfin/js/semTracking.js"></script>
			<div class="modal fade modal-form modal-otp" id="otp-modal" tabindex="-1" role="dialog" aria-labelledby="quote-formTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
				<div class="modal-dialog" role="document">
				<div class="modal-content mt-5">
					<div class="modal-header" id="header">
					<h5 class="modal-title" id="exampleModalCenterTitle">Please Enter the OTP</h5>
					</div>
					<div class="modal-body mt-3">	
					<div class="row book-appointment-sec text-center">
					<div class="col-12">
						<h2 class="margin-muted">Book your appointment online</h2>
						<h3>Save upto Rs.500</h3>
						<ul class="ul-sec d-inline-block text-left m-0 pl-0">
							<li>Priority Appointment</li>
							<li>Appointment at <span style="text-decoration: line-through;">Rs.800</span> Rs.299</li>
							<li>Upto 40% discount on diagnostics</li>
						</ul>
					</div>
					<div class="col-12">
						<h4 class="text-center mb-3">Consult with one of Medfin's expert surgeons today!</h4>
					</div>
				</div>
					<form id="otpForm">
									<div class="row">
										<div class="col-12">
											<div class="form-group">
												...
												<input type="number" class="form-control border-0" id="otpValue" name="otpValue"
							...
							<div class="row">
								<div class="col-12 text-center">
									<button type="button" class="btn btn-block btn-danger" onclick="MEDFINAPP.validateOTP('otpForm')">Validate OTP</button>
								</div>
							</div>
						</form>
					</div>
