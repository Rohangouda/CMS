...
<head>
    ...
    <title>Medfin</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('medfin/images/favicon.svg')}}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Mulish:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;0,1000;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900;1,1000&display=swap" rel="stylesheet">
    <!-- CSS only -->
    <!-- <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="css/slick-slider.min.css">
...
#header{ background-color: #4cbeac!important; color: #fff!important; border: none!important; margin-bottom: -6%; line-height: 1.1;}
.modal-dialog{ margin: 0px!important;}
    }
   


.book-appointment-sec h2{ font-size: 18px; font-weight: 700; margin-top: 0;}
.book-appointment-sec h3{ font-size: 32px; font-weight: 700; color: #4cbeac; margin: 0 0 20px 0;}
.book-appointment-sec h4{ font-size: 15px; font-weight: 700; color: #4cbeac; margin: 8px 0 10px 0;}
.book-appointment-sec ul li{ font-size: 16px; font-weight: 500; margin-bottom: 10px;}
.book-appointment-sec ul li:last-child{ margin-bottom: 0px;}
.book-appointment-sec img{ max-width:300px;}
...
src="https://www.facebook.com/tr?id=436206780236595&ev=PageView
&noscript=1"/>
</noscript>
...
<body>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-auto font-0">
                    <a href="#" class="navbar-logo">
                        <img src="{{ asset('medfin/images/logo.svg')}}" alt="medfin-logo" class="img-fluid">
                    </a>
                </div>
                ...
                <div class="col-auto ps-0 d-xl-none">
                    <!-- <a href="https://wa.me/+917406557599?text={{$whatsappText ?? 'Hello Team Medfin, trying to reach you'}}" class="callBtn whatsappBtn font--small">
                        WHATSAPP
                    </a> -->
                    <a class="callBtn scrollBtn whatsappBtn font--small" href="javascript:void(0)" data-toggle="modal" data-target="#appointment-form">
                        Book Appointment
                     </a>
                    <a href="tel:{{$contact}}" class="callBtn callnowBtn font--small">
                        CALL NOW
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <h1 class="display1--heading text-center text-md-start">
                        Minimally Invasive Knee Replacement Surgery Starting at Just  <span class="highligher"><span class="highligher-text">Rs. 1.6 Lakh</span></span>
                    ...
                    <div class="header__fetaurebox__wrapper">
                        ...
                        <div class="top-cards">
                            <div class="fetaurebox__cards">
                                <img src="{{ asset('medfin/images/emi-logo.svg')}}" alt="emi-logo" class="img-fluid d-block mx-auto">
                                <h6 class="fetaurebox__cards--title mt-2">
                                    Interest-free EMI
                                </h6>
                            </div>
                            <div class="fetaurebox__cards">
                                <img src="{{ asset('medfin/images/insuarance.svg')}}" alt="insuarance" class="img-fluid d-block mx-auto">
                                <h6 class="fetaurebox__cards--title mt-2">
                                    All insurances accepted
                                </h6>
                            </div>
                    ...
                    <div id="listbox" class="formbox mx-auto me-md-0">
                        ...
                        <form class="w-100 mt-4" id="book-appointment" name="book-appointment">
                            <div class="medfin__formgroup">
                                <input type="text" class="form-control input--box" placeholder="Full Name" name="name" id="name">
                            </div>
                            <input id="service" name="service" type="hidden" class="hidden" value="13">
                            <div class="medfin__formgroup">
                                <div class="flagbox">
                                    <img src="{{ asset('medfin/images/flag-ind.png')}}" alt="flag-ind">
                                    +91
                                </div>
                                <input type="tel" class="form-control input--box ps--6" placeholder="Phone Number" name="mobile" id="mobile">
                            </div>
                            <!-- <div class="medfin__formgroup">
            ...
            <div class="container">
                <div class="patient__grid__items mx-auto">
                    <div class="patient__item">
                        <div>
                            <img src="{{ asset('medfin/images/happy-patients.svg')}}" alt="happy-patients" class="img-fluid">
                        </div>
                        <div>
                    ...
                    <div class="patient__item">
                        <div>
                            <img src="{{ asset('medfin/images/specialists.svg')}}" alt="specialists" class="img-fluid">
                        </div>
                        <div>
                            <h5 class="patient__item--title">
                                100 +
                    ...
                    <div class="patient__item">
                        <div>
                            <img src="{{ asset('medfin/images/surgery-centers.svg')}}" alt="surgery-centers" class="img-fluid">
                        </div>
                        <div>
                            <h5 class="patient__item--title">
                                30 +
                    ...
                    <div class="patient__item">
                        <div>
                            <img src="{{ asset('medfin/images/cities.svg')}}" alt="cities" class="img-fluid">
                        </div>
                        <div>
                            <h5 class="patient__item--title">
                                15 +
            ...
            <div class="plans__wrapper">
                        ...
                        <div class="plans__wrapper--column2">
                            <div class="current__plans">
                                <div class="current__plans--logo">
                                    <img src="{{ asset('medfin/images/logo.svg')}}" alt="logo" class="img-fluid d-block mx-auto">
                                </div>
                            </div>
                        ...
                        <div class="plans__wrapper--column2">
                            ...
                            <div class="row mx-0">
                                <!-- <div class="col-md-4 px-0">
                                    <div class="plan__box">
                                        ...
                                        <div class="plan__box--cell bg--fa text--grey">
                                            <span>Starting from Rs. 31,667 per month</span>
                                        </div>
                                        <div class="plan__box--cell bg-white text--grey">
                                ...
                                <div class="col-md-6 px-0">
                                    <div class="plan__box">
                                        ...
                                        <div class="plan__box--cell bg-white text--grey">
                                            <img src="{{ asset('medfin/images/smith.png')}}" alt="smith" class="img-fluid d-block mx-auto">
                                        </div>
                                        <div class="plan__box--cell bg--fa text--grey">
                                        ...
                                        <div class="plan__box--cell bg-white text--grey">
                                            <!-- <img src="https://medfincms.s3.ap-south-1.amazonaws.com/knee-replacement-image/johnson.png" alt="johnson" class="img-fluid d-block mx-auto"> -->
                                            <span>National/International Implants</span>
                                        </div>
                                        <div class="plan__box--cell bg--fa text--grey">
                                            <span>Small Incisions</span>
                                        </div>
                                        ...
                                        <div class="plan__box--cell bg--fa text--grey">
                                            <span>Starting from Rs. 29,167 per month</span>
                                        </div>
                                        <div class="plan__box--cell bg-white text--grey">
                                            <img src="{{ asset('medfin/images/tick-correct.svg')}}" alt="tick" class="img-fluid d-block mx-auto">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 px-0">
                                    <div class="plan__box">
                                        <div class="position-relative">
                                            ...
                                            <div class="plan__box plan__box-none">
                                                <div class="plan__box--cell active plan__box-headercell ribbon" data-ribbon="Most Popular">
                                                    Minimally invasive      <br> Knee replacement
                                                </div>
                                                <div class="plan__box--cell fw-bold bg--fa text--grey">
                                                ...
                                                <div class="plan__box--cell bg--fa text--grey">
                                                    <span>Starting from Rs. 16,667 per month</span>
                                                </div>
                                                <div class="plan__box--cell bg-white text--grey">
                                                    <img src="{{ asset('medfin/images/tick-correct.svg')}}" alt="tick-correct" class="img-fluid d-block mx-auto">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="other__plans">
                                <div class="plan__box">
                                    ...
                                    <div class="plan__box--cell bg-white text--grey">
                                        <img src="{{ asset('medfin/images/wrong-tick.svg')}}" alt="wrong-tick" class="img-fluid d-block mx-auto">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-6 px-0">
                                    <div class="current__plans--logo max--80">
                                        <img src="{{ asset('medfin/images/logo.svg')}}" alt="logo" class="img-fluid d-block ms-auto">
                                    </div>
                ...
                <div class="row justify-content-md-center mt--40">
                    ...
                    <div class="col-12 col-md-auto mt-3 mt-md-0">
                        <a href="tel:+917026200200" class="callus--btn w-100 d-lg-none">
                            CALL US
                        </a>
            ...
            <div class="row pt-md-4">
                <div class="col-6 col-md-3 mt-4">
                    <div class="list__types">
                        <span>
                            <img src="{{ asset('medfin/images/insure-tick.svg')}}" alt="insure-tick" class="img-fluid">
                        </span>
                        <div>
            ...
            <div class="row justify-content-center mt-4 mx-ng-2">
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/star.png')}}" alt="star" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/care.png')}}" alt="care" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/niva.png')}}" alt="niva" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/hdfc.png')}}" alt="hdfc" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/bajaj.png')}}" alt="bajaj" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/tata.png')}}" alt="tata" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="h{{ asset('medfin/images/aditya.png')}}" alt="aditya" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/sbi.png')}}" alt="sbi" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/reliance.png')}}" alt="reliance" class="img-fluid">
                    </div>
                </div>
                <div class="col-3 col-lg-2b">
                    <div class="partner--box">
                        <img src="{{ asset('medfin/images/icici.png')}}" alt="icici" class="img-fluid">
                    </div>
                </div>
            </div>
    ...
    <section class="spacer__section pb-0 bg--pattern">
        <div class="container text-center">
            <h2 class="section--title text-white max--800 mx-auto">
                Minimally invasive Total Knee Replacement starting at just Rs. 16,667* per month
            </h2>
            ...
            <div class="container">
                ...
                <div class="card__layout__grid mt--60">
                    <div class="card--box d-flex flex-column">
                        ...
                        <div class="card--boxinfo">
                            <div class="card--box--pic">
                                <img src="{{ asset('medfin/images/sai.png')}}" alt="sai">
                            </div>
                        ...
                        <div>
                            <p class="card--box--author mt-2"><b>Official london Olympics doctor in 2012</b><br>
                                Operated Surgeries in:<br>
                                1. Hosmat Hospital<br>
                                2. Fortis Hospital<br>
                                3. Manipal Hospital</p>
                            </div>
                        <div class="card--box--text mb-2">
                        Dr. Sai Krishna B Naidu is a highly accomplished Trauma & Orthopedic Surgeon with 21 years of experience, specialized in orthopedics with an MSc in Ortho from Anglia Ruskin University, Cambridge. He has served as the Official London Olympics Doctor in 2012 and has performed over 3000 orthopedic surgeries, showcasing his skills and proficiency in surgical procedures.
                         Best paper London knee meeting on robotic knee replacement future of knee replacement 2013.
                        </div>
                    ...
                    <div class="card--box d-flex flex-column">
                        ...
                        <div class="card--boxinfo">
                            <div class="card--box--pic">
                                <img src="{{ asset('medfin/images/ananya.png')}}" alt="ananya">
                            </div>
                            <div class="card--box--desc">
                                <h6 class="card--box--title">
                                    Dr. Ananya Puttaraju
                        ...
                        <div>
                            <p class="card--box--author mt-2"><br>
                                Operated Surgeries in:<br>
                                1. Hosmat Hospital<br>
                                2. Sparsh Hospital<br>
                                3. Tameside General Hospital, UK</p>
                            </div>
                        <div class="card--box--text mb-2">
                        Dr. Ananya is an Orthopedic surgeon and Joint Replacement Surgeon in Bangalore with 20 years of experience. He has completed MBBS and FRCS in Trauma & Orthopedic Surgery and is a member of various orthopedic associations. With 3220+ surgeries performed, he has operated in top hospitals, including Hosmat Hospital, Sparsh Hospital, and Tameside General Hospital, UK. Dr. Ananya provides services like Back Pain Treatment, Joint and Muscle Problems, Ligament Reconstruction, Shoulder SLAP (Tear) Lesions, and Ligament and Tendon Repair.
                        </div>
                        <div class="text-end mt-auto">
                    ...
                    <div class="card--box d-flex flex-column">
                        ...
                        <div class="card--boxinfo">
                            <div class="card--box--pic">
                                <img src="{{ asset('medfin/images/sakshi.png')}}" alt="sakshi">
                            </div>
                            <div class="card--box--desc">
                                <h6 class="card--box--title">
                                    Dr. Shashikiran R
                        ...
                        <div>
                            <p class="card--box--author mt-2"><br>
                                Operated Surgeries in:<br>
                                1. Manipal hospital<br>
                                2. Hosmat Hospital<br>
                                3. Global Hospitals</p>
                            </div>
                        <div class="card--box--text mb-2">
                        Dr. Shahsikiran R is an Orthopedic surgeon with specialized fellowships in Arthroscopy and Sports Medicine from Global Hospitals in 2013, Joint Replacement Surgery from Hosmat Hospital in Bangalore in 2015, and Shoulder and Sports Medicine from Samsung Medical Center in Seoul, South Korea in 2016. He has worked at HOSMAT Hospital and is well-versed in the latest techniques and treatments in his field.
                        </div>
                        <div class="text-end mt-auto">
                    ...
                    <div class="card--box d-flex flex-column">
                        ...
                        <div class="card--boxinfo">
                            <div class="card--box--pic">
                                <img src="{{ asset('medfin/images/sarath.png')}}" alt="sarath">
                            </div>
                            <div class="card--box--desc">
                                <h6 class="card--box--title">
                        ...
                        <div class="card--box--text mb-2">
                        Dr. Sharath Kumar Shetty is an experienced Orthopaedic surgeon specializing in Joint replacement surgeries, complex trauma surgeries, Knee Arthroscopy, Spine Instrumentation, Vertebroplasty, and Discectomy. With over 22 years of experience, he has performed numerous complex surgeries, including Revision trauma and Primary Knee and Hip Replacement surgeries.
                        </div>
                        <div class="text-end mt-auto">
    ...
    <section class="spacer__section bg--F8F9FC">
        <div class="container">
            ...
            <div class="text-center mt-3">
                <a href="tel:+917026200200" class="callus--btn w-100 w-md-auto d-lg-none">
                    CALL US
                </a>
    ...
    <div class="custom__navbar bottombar d-lg-none">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-6">
                    <!-- <a href="https://wa.me/+917406557599?text={{$whatsappText ?? 'Hello Team Medfin, trying to reach you'}}" class="callBtn whatsappBtn w-100 font--small">
                        WHATSAPP
                    </a> -->
                    <!-- <a  class="scrollBtn callBtn whatsappBtn font--small">
                            Book Appointment
                            </a> -->
                            <a class="scrollBtn callBtn whatsappBtn font--small"  href="javascript:void(0)" data-toggle="modal" data-target="#appointment-form"> BOOK APPOINTMENT</a>
                </div>
                <div class="col-6">
                    <a href="tel:{{$contact}}" class="callBtn callnowBtn w-100 font--small">
                        CALL NOW
                    </a>
                </div>
            </div>
...
<div class="modal fade sidebar-form" id="appointment-form" tabindex="-1" role="dialog" aria-labelledby="lead-formTitle" aria-hidden="true">
						<div class="modal-dialog" role="document">
                            ...
                            <form class="w-100 mt-4" id="book-appointment1" name="book-appointment1">
                            <div class="medfin__formgroup">
                                <input type="text" class="form-control input--box" placeholder="Full Name" name="name" id="name">
                            </div>
                            <input id="service" name="service" type="hidden" class="hidden" value="13">
                            ...
                            <div class="medfin__formgroup mt-4">
                                <a class="secondaryBtn text-uppercase w-100" onclick="MEDFINAPP.createLeadRequestWithSource('book-appointment1','NORMAL-FLOW','','Book Appointment');" href="javascript:void(0)">
                                    Submit details
                              </a>
                            </div>
                        </form>
                    ...
                    <div class="card--boxinfo">
                        ...
                        <div class="card--box--desc">
                            ...
                            <div class="row mt-2">
                                ...
                                <p class="d-flex flex-wrap align-items-center card--box--author mt-1"><b> Official london Olympics doctor in 2012 </b></p>
                                <div>
                            </div>
...
Best paper London knee meeting on robotic knee replacement future of knee replacement 2013.
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <div class="col-12 col-md-auto">
                        <a href="tel:+917026200200" class="callus--btn min-w-auto d-lg-none w-100 w-md-auto">
                            CALL US
                        </a>
                ...
                <div class="modal-body">
                    <div class="card--boxinfo">
                        ...
                        <div class="card--box--desc">
                            ...
                            <div class="col-auto">
                                <p class="d-flex flex-wrap align-items-center card--box--author mt-1"> Operated Surgeries in : <br>
                                1. Manipal hospital <br>
                                2. Hosmat Hospital <br>
                                3. Global Hospitals </p>
				...
				<div class="modal-content mt-5">
					...
					<div class="col-12">
						...
						<ul class="ul-sec d-inline-block text-left m-0 pl-0">
							...
							<li>Appointment at <span style="text-decoration: line-through;">Rs.800</span> Rs.199</li>
					...
					<form id="otpForm">
									<div class="row">
										<div class="col-12">
											<div class="form-group">
												...
												<input type="number" class="form-control" id="otpValue" name="otpValue"
							...
							<div class="row">
								<div class="col-12 text-center">
									<button type="button" class="btn btn-block btn-danger mt-2" onclick="MEDFINAPP.validateOTP('otpForm')">Validate OTP</button>
								</div>
							</div>
						</form>
					</div>
    ...
    <script src="{{asset('medfin/js/semTracking.js')}}"></script>
